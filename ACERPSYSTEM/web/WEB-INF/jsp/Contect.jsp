...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div style="background: url(images1/galleries/style/458/splash_bg.png) top center no-repeat #fff;">
            <div id="wrapper">
                <%@include file="OuterLook/Logo.jsp" %>
                <%@include file="OuterLook/Contactbody.jsp" %>
            </div>
        </div>
        ...
        <script type="text/javascript" src="images1/jq/jquery-1.6.2.min.js"></script>
        <script type="text/javascript" src="images1/jq/jquery.bvalidator.js"></script>
        <script type="text/javascript">
        ...
        <link href="images1/jq/bvalidator.theme.gray2.css" rel="stylesheet" type="text/css" />
