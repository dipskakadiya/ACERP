...
<div>
    ...
    <script>
        $(document).ready(function() {
            $.pnotify({
                ...
                pnotify_text: 'Bank Transection Restore Successfully',
    ...
    <script>
        $(document).ready(function() {
            $.pnotify({
                pnotify_title: 'Success Notification',
                pnotify_text: 'Bank Transection Deleted Successfully',
                pnotify_animation: {effect_in: function(status, callback, pnotify){
                        var source_note = 'Always call the callback when the animation completes.';
                        var cur_angle = 0;
                        var cur_opacity_scale = 0;
            ...
            <table class="mws-datatable-fn mws-table">
                ...
                <tbody>
                    ...
                    <tr class="gradeX">
                        ...
                        <td><% out.print(hmTrash.get("CHK_NO"));%></td>
                        <td><% out.print(hmTrash.get("CHK_DATE"));%></td>
                    </tr>
                    <%}
                        }%>
                </tbody>
                <div align="center" class="mws-button-row">
                    ...
                    %>
                    <input type="submit" class="mws-button save green" name="action" value="Restore_Bank" />
                    <%}%>
                    <% if (UST.equals("Admin") || (UST.equals("User") && (hper.get("P_Delete").toString().equals("1")))) {%>
                    <input type="submit" class="mws-button save green" name="action" value="Delete_Bank" />
                    <%}%>
