...
<div>
    ...
    <script>
        $(document).ready(function() {
            $.pnotify({
                ...
                pnotify_text: 'Trade Restore Successfully',
    ...
    <script>
        $(document).ready(function() {
            $.pnotify({
                pnotify_title: 'Success Notification',
                pnotify_text: 'Trade Deleted Successfully',
                pnotify_animation: {effect_in: function(status, callback, pnotify){
                        var source_note = 'Always call the callback when the animation completes.';
                        var cur_angle = 0;
                        var cur_opacity_scale = 0;
        ...
        <div class="mws-panel-body">
            <table class="mws-datatable-fn mws-table">
                ...
                <tbody>
                    ...
                    %>
                    <tr class="gradeX">
                        <td><input type="checkbox" id="Trash" name="Trash" value="<%out.print(hmTrash.get("Bill_no"));%>" ></td>
                        <td><%  out.print(hmTrash.get("Bill_No"));%></td>
                        <td><%  out.print(hmTrash.get("Book_Name"));%></td>
                        <td>
                        ...
                        <td><%  out.print(hmTrash.get("Due_Days"));%></td>
                        <td><%  out.print(hmTrash.get("Bill_Mode"));%></td>
                    </tr>
                    <%}
                        }%>
                </tbody>
                <div align="center" class="mws-button-row">
                    ...
                    %>
                    <input type="submit" class="mws-button save green" name="action" value="Restore_Trade" />
                    <%}%>
                    <% if (UST.equals("Admin") || (UST.equals("User") && (hper.get("P_Delete").toString().equals("1")))) {%>
                    <input type="submit" class="mws-button save green" name="action" value="Delete_Trade" />
                    <%}%>
